...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if ($conn->query($sql) === TRUE && $conn->query("CREATE DATABASE $username") === TRUE) {
		...
		$conn->query("CREATE TABLE `$username`.`logcfg` ( `device_id` INT UNSIGNED NOT NULL PRIMARY KEY, `device_name` VARCHAR(32) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;");
